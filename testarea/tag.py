...
if __name__ == '__main__':
  ...
  b = 109694242877358678759117926560535314560097671873397587631955617694808210953112
  a = [185, 77, 39, 185, 147, 77, 62, 8, 165, 46, 82, 215, 218, 125, 171, 250, 196, 132, 239, 227, 122, 83, 128, 238, 144, 136, 247, 172, 226, 239, 205, 233]
  print(t)
  print(pk.group.hash((b, b),ZR))
